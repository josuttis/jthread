...
\begin{itemize}
 ...
 \item \tcode{stop_callback} stores lvalue reference for passed \tcode{std::reference_wapper<>}.
...
unless a \tcode{std::reference_wrapper<>} is passed.
If a \tcode{std::reference_wrapper<>} is passed,
...
\endhead
 ...
 \tcode{stop_callback cb\{token, ref(stop)\}; }
  &
        ...
        Deduces \tcode{callback_type} as \tcode{decltype(stop)\&}.
