...
\begin{itemdescr}
  \pnum\effects If \tcode{rhs} is not valid, constructs an \tcode{interrupt_token} object
                ...
                that shares the ownership of the interrupt signal with \tcode{rhs}.
...
\begin{itemdescr}
 \pnum\effects If \tcode{valid()} and \tcode{*this} is the last owner of the interrupt signal,
                destroys the underlying interrupt signal.
\end{itemdescr}
