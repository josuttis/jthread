...
\begin{itemdescr}
  \pnum\effects Initialises \tcode{callback} with \tcode{static_cast<Callback\&\&>(cb)}.
                ...
                on any \tcode{stop_source} instance \tcode{src} that references the same atomic stop
                state as \tcode{st}.
...
\begin{itemdescr}
  \pnum\effects Deregisters the callback from the associated atomic stop state.
                ...
                A subsequent call to \tcode{src.request_stop()} on any \tcode{stop_source} \tcode{src} with the same
