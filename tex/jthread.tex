...
The program is ill-formed, if the definition of \tcode{stop_callback} is
instantiated with a type as the argument for the template parameter
\tcode{Callback} that does not satisfy \tcode{Invocable} or does not satisfy
\tcode{Destructible}.
%If Callback does not satisfy Invocable or does not satisfy
%Destructible, the program is ill-formed.
