...
with the additional ability to request to stop and to
...
\pnum
The following wait functions ensure to stop waiting
as soon as there is a request to stop for the passed \tcode{stop_token}.
In that case the functions return immediatelly
...
\end{codeblock}
 ...
 \pnum \begin{note} The returned value indicates whether the predicate evaluated to
        ...
        there was a request to stop. \end{note}

 \pnum \postconditions \tcode{lock} is locked by the calling thread unless an exception is thrown.
...
stoken is not stop_possible, it was already requested to stop, or
...
regardless of whether the timeout was triggered. \end{note}
 ...
 \pnum \begin{note} The returned value indicates whether the predicate evaluated to
        ...
        or it was requested to stop. \end{note}
