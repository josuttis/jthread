...
\begin{note} Implementations are expected to implement interruption in terms of a
             ...
             to be called by \tcode{interruption_token::interrupt()} in a future version of C++.
             \end{note}
}
...
\begin{itemdescr}
  ...
  \pnum\effects If \tcode{!valid()} or \tcode{is_interrupted()} the call has no effect. 
                ...
                \begin{note} Signaling an interrupt includes notifying all condition variables
                             ...
                             temporarily registered during an interruptable wait (\ref{thread.condition.interrupt_token})
                             \end{note}
...
\begin{note} 
        ...
        \tcode{is_interrupted()}, their calls synchronize with \tcode{interrupt()}.
      \end{note}
